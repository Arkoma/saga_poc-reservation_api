...
class ReservationControllerIT {
    ...
    static {
        try {
            start = new SimpleDateFormat("dd MMM yyyy").parse("12 Apr 2022");
            finish = new SimpleDateFormat("dd MMM yyyy").parse("19 Apr 2022");
    ...
    void setup() {
        ...
        reservation.setCustomerName("Rob Parrot");
        reservation.setHotelName("Holiday Inn");
        reservation.setRoom(123);
        reservation.setHotelCheckinDate(start);
        reservation.setHotelCheckoutDate(finish);
        reservation.setCarMake("Tesla");
        reservation.setCarModel("CyberTruck");
        reservation.setCarAgency("Hertz");
        reservation.setCarRentalDate(start);
        reservation.setCarReturnDate(finish);
        reservation.setFlightNumber("880");
        reservation.setSeatNumber("14b");
        reservation.setFlightDepartureDate(start);
        reservation.setFlightReturnDate(finish);
